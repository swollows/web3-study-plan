...
**개요**
OpenZeppelin이 운영하는 온체인 워게임. 브라우저 콘솔 또는 Foundry/Hardhat으로 풀 수 있으며, 실제 테스트넷(Sepolia)에 배포된 컨트랙트를 공격한다. 스마트 컨트랙트 보안의 ABC를 배우는 데 가장 적합하다.

- URL: https://ethernaut.openzeppelin.com
- 총 문제 수: 29문제 (2025년 기준)
- 난이도: 초급~중급
- 언어: Solidity (일부 어셈블리)
- 환경: Sepolia 테스트넷, MetaMask 필요
...
### Month 1: 기초 (Ethernaut 완주)
- Week 1-2: Ethernaut 0-15번
- Week 3-4: Ethernaut 16-29번 + EVM Puzzles

### Month 2: DeFi 심화 (Damn Vulnerable DeFi)
- Week 1-2: DVDeFi 1-9번
- Week 3-4: DVDeFi 10-18번

### Month 3: 실전 전환
- Week 1: Mr Steal Yo Crypto
- Week 2: DeFiHackLabs 재현 5건
- Week 3-4: Secureum RACE 과거 문제 모두 풀기

### Month 4: 대회 참가
- Code4rena 첫 감사 참여
- Paradigm CTF 과거 문제 도전
- 첫 버그바운티 보고서 제출
